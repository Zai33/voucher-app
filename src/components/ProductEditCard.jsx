...
const ProductEditCard = () => {
  ...
  return (
    <div className=" px-10 py-8 rounded-lg shadow-lg mt-5 w-full md:w-1/2 lg:w-3/4">
      ...
      {isLoading ? (
        <div className="animate-pulse">
          ...
          <div className="text-end flex space-x-2">
        ...
        <form onSubmit={handleSubmit(handleCreateProduct)}>
          <div className=" mb-5">
            ...
            <input
              ...
              } text-gray-900 font-semibold text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
            ...
            <input
              ...
              className={`bg-gray-50 border ${
                errors.price
                  ? "border-red-500 focus:ring-red-500 focus:border-red-500"
                  : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
              } text-gray-900 text-sm font-semibold rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
